...
BOT_USERNAME = getenv("BOT_USERNAME" , "BESTIE")
...
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/II_KRISHAN_GYAN_II")
...
autoclean = []
confirmer = {}
START_IMG_URL = getenv("START_IMG_URL", "https://files.catbox.moe/p6n668.jpg")
